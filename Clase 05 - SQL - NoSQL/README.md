...
# Base de datos SQL
Nace como herramienta para hacer consultas y almacenar tablas relacionales.
...
## BASE (Básicamente disponible - Soft State - Consistencia eventual)
...
Esto significa que te va a devolver la data hasta donde está (en medio de la transacción), por lo que puede verse afectada la consistencia, ligeramente.
